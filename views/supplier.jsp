		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					...
					<ul class="nav navbar-nav">
						<li class="menu-item active"><a href="categories">Category
						</a></li>
						<ul class="nav navbar-nav">
		...
		<table align="center">
			<tr>
				...
				<c:choose>
					...
					<c:otherwise>
						<td><form:input path="id"  pattern=".{9,10}" required="true"
								title="id should contains 9 to 10 characters" /></td>
					</c:otherwise>
				</c:choose>
			<tr>
			...
			<tr>
				<td colspan="2"><c:if test="${!empty supplier.name}">
							...
							<button type="submit" class="btn btn-warning" value="<spring:message text="Edit Supplier"/>">Edit Supplier </button>
						
					</c:if> <c:if test="${empty supplier.name}">
						<button type="submit" class="btn btn-success" value="<spring:message text="Add Category"/>">Add Supplier </button>
