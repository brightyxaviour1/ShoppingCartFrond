...
<center>
	...
	<img
		src="C:\Users\USER\Downloads\NIIT\DT workspace\E-Comerse worbSpace_01_D\ShoppingCartFrontEnd\src\main\webapp\resources\images\login.jpg"
	...
	<form:form action="Login" method="post">
			<table>
				...
				<!-- <p>
					New User? <a href="RegisterHere"
						class="btn btn-primary btn-sm" role="button">Register Here</a>
				</p> -->
	...
	<form:form action="${action}" method="post">
		<div class="login">
			<input type="text" placeholder="Username" name="id" required="true">
			<input type="password" placeholder="password" name="password"
				required="true"> <a href="#" class="forgot">forgot
				password?</a> <input type="submit" value="Sign In">
		</div> 
